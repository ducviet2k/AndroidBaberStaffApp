...
public class NotificationActivity extends AppCompatActivity implements INotificationLoadListener {
    ...
    CollectionReference noficationCollection;
    ...
    private void initView() {
        ...
        recyclerview_notification.addItemDecoration(new DividerItemDecoration(this, layoutManager.getOrientation()));

        recyclerview_notification.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
    ...
    private void loadNotification(DocumentSnapshot lastDoc) {
        ...
        noficationCollection = FirebaseFirestore.getInstance()
                .collection("AllSalon")
        ...
        if (lastDoc == null) {
            noficationCollection.orderBy("serverTimestamp", Query.Direction.DESCENDING)
