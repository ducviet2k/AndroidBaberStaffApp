...
import com.example.androidbaberstaffapp.Adapter.MySalonAdapter;
...
import com.example.androidbaberstaffapp.Interface.IOnLoadCountSalon;
...
public class SalonListActivity extends AppCompatActivity implements IOnLoadCountSalon, IBranchLoadListener, IGetBarberListener, IUserLoginRemeberListener {
    ...
    public void onUserLoginSuccess(String user) {
        //save user
        Paper.init(this);
        Paper.book().write(Common.LOGGER_KEY, user);
